...
const CustomDrawerContent = (props) => {
    ...
    const menuItems = [
        { name: 'Home', label: `👤 ${t.navProfile}`, screen: 'Home' },
        { name: 'Tasks', label: `📋 ${t.navTasks}`, screen: 'Tasks' },
        { name: 'Combat', label: `⚔️ ${t.navCombat}`, screen: 'Combat' },
        { name: 'Shop', label: `🛒 ${t.navShop}`, screen: 'Shop' },
        { name: 'Forge', label: `⚒️ ${t.navForge}`, screen: 'Forge' },
        { name: 'Inventory', label: `🎒 ${t.navInventory}`, screen: 'Inventory' },
        { name: 'Skills', label: `🎯 ${t.navSkills}`, screen: 'Skills' },
        { name: 'Stats', label: `📊 ${t.navStats}`, screen: 'Stats' },
    ];
    ...
    return (
        ...
        >
            ...
            <Drawer.Screen
                ...
                options={{ title: `📋 ${t.navTasks}` }}
            />
            <Drawer.Screen
                name="Combat"
                component={CombatScreen}
                options={{ title: `⚔️ ${t.navCombat}` }}
            />
            <Drawer.Screen
                name="Shop"
                component={ShopScreen}
                options={{ title: `🛒 ${t.navShop}` }}
            />
            <Drawer.Screen
                name="Forge"
                component={ForgeScreen}
                options={{ title: `⚒️ ${t.navForge}` }}
            />
            <Drawer.Screen
                name="Inventory"
                component={InventoryScreen}
                options={{ title: `🎒 ${t.navInventory}` }}
            />
            <Drawer.Screen
                name="Skills"
                component={SkillsScreen}
                options={{ title: `🎯 ${t.navSkills}` }}
            />
            <Drawer.Screen
                name="Stats"

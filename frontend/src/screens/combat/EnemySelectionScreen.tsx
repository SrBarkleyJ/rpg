        ...
        <View style={[styles.enemyCard, { backgroundColor: theme.surface, borderColor: theme.border, borderWidth: 2, borderRadius: 8, padding: 16 }]}>
            ...
            <View style={styles.statsRow}>
                <View style={styles.stat}>
                    <Text style={[styles.statLabel, { color: theme.secondary }]}>HP</Text>
                    <Text style={[styles.statValue, { color: theme.danger }]}>{item.stats.hp}</Text>
                </View>
                <View style={styles.stat}>
                    <Text style={[styles.statLabel, { color: theme.secondary }]}>STR</Text>
                    <Text style={[styles.statValue, { color: theme.warning }]}>{item.stats.strength}</Text>
                </View>
                <View style={styles.stat}>
                    <Text style={[styles.statLabel, { color: theme.secondary }]}>DEF</Text>
            ...
            >
                <Text style={[styles.fightButtonText, { color: theme.textLight }]}>⚔️ FIGHT</Text>
            </TouchableOpacity>
        </View>
    );
        ...
        <View style={[styles.container, { backgroundColor: theme.background }]}>
            <View style={styles.header}>
                <TouchableOpacity onPress={onBack}>
                    <Text style={[styles.backButton, { color: theme.textLight }]}>← Back</Text>
                </TouchableOpacity>
                <Text style={[styles.title, { color: theme.textLight }]}>SELECT ENEMY</Text>
                <View style={{ width: 60 }} />
            </View>

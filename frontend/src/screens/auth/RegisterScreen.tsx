...
const RegisterScreen: React.FC<Props> = ({ navigation }) => {
    ...
    const handleRegister = async () => {
        ...
        try {
            setLoading(true);
            console.log('Registering user:', { username, email, class: selectedClass, avatar: selectedAvatar });

            const result = await register(username, email, password, selectedClass, selectedAvatar);
    ...
    return (
        <ScrollView style={[styles.container, { backgroundColor: theme.background }]} contentContainerStyle={styles.scrollContent}>
            ...
            {selectedClass && (
                <>
                    <Text style={[styles.sectionTitle, { color: theme.textLight }]}>SELECT YOUR AVATAR</Text>
            ...
            <TouchableOpacity
                style={[
                    ...
                    (!selectedClass || !selectedAvatar || loading) && styles.buttonDisabled
                ]}
                onPress={handleRegister}
                disabled={!selectedClass || !selectedAvatar || loading}
            >
                {loading ? (
